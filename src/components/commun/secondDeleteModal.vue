<template>
  <TransitionRoot appear :show="useWidget.secondDeleteModal.open" as="template">
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <div v-if="!useWidget.secondDeleteModal.open"
              ...
              <div v-else class="w-full flex flex-col h-fit gap-2 items-center justify-center">
                ...
                <span class="mb-6">{{ t('translation.youWillDelete') }} <span class="font-semibold">{{
                  useWidget.secondDeleteModal.designation
                    }}</span></span>
                ...
                <div class="w-full h-10 grid grid-cols-2 gap-4">
                  ...
                  <button :disabled="loadingDelete" @click="deleteItem(useWidget.secondDeleteModal.id)"
...
const closeModal = () => {
  Object.assign(useWidget.secondDeleteModal, {
    id: null,
    designation: null,
    open: false,
  })
...
watch(() => useWidget.secondDeleteModal.open, () => {
  if (useWidget.secondDeleteModal.open) return
  else {
